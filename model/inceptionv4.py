...
class Inception_B(nn.Module):
    ...
    def forward(self, x):
        ...
        # x2 = self.branch_2(x)
        x3 = self.branch_3(x)
        return torch.cat((x0,x1,x3), dim=1)  #768
...
class Inceptionv4(nn.Module):
    ...
    def __init__(self, in_channels=3, classes=1000, k=96, l=112, m=128, n=192):
        ...
        # for i in range(1):
        blocks.append(Inception_B(704)) # 原来是1024
        # blocks.append(Reduction_B(1024))
        # for i in range(1):
        # blocks.append(Inception_C(1536))
        self.features = nn.Sequential(*blocks)
        self.global_average_pooling = nn.AdaptiveAvgPool2d((1, 1))
        self.linear = nn.Linear(768, classes)  # 原来1024
...
# 增加可读性
    ...
    model = Inceptionv4(classes=27249)
