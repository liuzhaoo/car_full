...
# /home/zhaoliu/car_class/dataset/qczj_train_all_lmdb.npy
    parser.add_argument('--root_path',
                        default='/mnt/data/zhaoliu_data/lmdb',
                        type=str,
                        help='root dir path')
    ...
    parser.add_argument('--keys_path_train',
                        default='/home/zhaoliu/car_class/dataset/car_256_all_lmdb.npy',
                        type=str,
    ...
    parser.add_argument('--val_data',
                        default='carlogo_test/allnewdata_img_test_lmdb',
                        type=str,
    ...
    parser.add_argument('--result_path',
                        default='/home/zhaoliu/car_class/results/chexing/resnet18_large_dist',
                        type=Path,
